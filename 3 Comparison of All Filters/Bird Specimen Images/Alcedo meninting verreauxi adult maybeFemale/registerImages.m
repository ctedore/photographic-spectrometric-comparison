...
% Auto-generated by registrationEstimator app on 24-Oct-2022
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',510.324097,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',510.324097,'NumOctaves',4,'NumScaleLevels',6);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',21.672211,'MaxRatio',0.216722);

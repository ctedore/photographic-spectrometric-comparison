function [OUTPUT] = registerImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 27-Oct-2022
%-----------------------------------------------------------
...
fixedPoints = detectMSERFeatures(FIXED,'ThresholdDelta',0.800000,'RegionAreaRange',[10 28000],'MaxAreaVariation',1.000000);
movingPoints = detectMSERFeatures(MOVING,'ThresholdDelta',0.800000,'RegionAreaRange',[10 28000],'MaxAreaVariation',1.000000);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',30.393066,'MaxRatio',0.303931);
...
% undo image normalization (Cynthia added this)
MOVINGREG.RegisteredImage = MOVINGREG.RegisteredImage .* (MOVINGmax - MOVINGmin) + MOVINGmin; 
OUTPUT = MOVINGREG.RegisteredImage;

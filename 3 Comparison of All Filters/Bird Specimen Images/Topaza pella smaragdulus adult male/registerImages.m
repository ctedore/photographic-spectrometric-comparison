...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',508.637238,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',508.637238,'NumOctaves',4,'NumScaleLevels',6);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',22.909241,'MaxRatio',0.229092);

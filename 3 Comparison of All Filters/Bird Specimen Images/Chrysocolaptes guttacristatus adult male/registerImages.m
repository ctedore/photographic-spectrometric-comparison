...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',510.218811,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',510.218811,'NumOctaves',4,'NumScaleLevels',6);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',28.249207,'MaxRatio',0.282492);

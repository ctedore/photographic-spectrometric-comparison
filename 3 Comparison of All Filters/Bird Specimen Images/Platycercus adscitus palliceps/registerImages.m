...
fixedPoints = detectMSERFeatures(FIXED,'ThresholdDelta',0.879023,'RegionAreaRange',[10 27654],'MaxAreaVariation',0.977775);
movingPoints = detectMSERFeatures(MOVING,'ThresholdDelta',0.879023,'RegionAreaRange',[10 27654],'MaxAreaVariation',0.977775);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',14.204407,'MaxRatio',0.142044);
